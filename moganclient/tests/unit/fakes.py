...
class FakeServer(object):
    ...
    def create_one_server(attrs=None):
        ...
        server_info = {
            ...
            "description": "fake_description",
            "image_uuid": "image-id-" + dutils.generate_uuid(dashed=False)ex,
            "instance_type_uuid": "server-type-id-" + uuidutils.generate_uuid(dashed=False),
            "links": [],
            "name": "server-name-" + uuidutils.generate_uuid(dashed=False),
            "network_info": {"net-id-" + uuidutils.generate_uuid(dashed=False): {}},
            "updated_at": None,
            "uuid": "server-id-" + uuidutils.generate_uuid(dashed=False),
            "availability_zone": "zone-name-" + uuidutils.generate_uuid(dashed=False),
            'extra': "fake_extra"
        }
