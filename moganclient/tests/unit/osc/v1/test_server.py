...
class TestServerList(test_base.TestBaremetalComputeV1):
    ...
    def test_server_list(self, mock_list, mock_find):
        network_obj = mock.Mock()
        network_obj.name = 'private'
        mock_find.return_value = network_obj
        arglist = []
        verifylist = []
    ...
    def test_server_list_long(self, mock_list, mock_find):
        network_obj = mock.Mock()
        network_obj.name = 'private'
        mock_find.return_value = network_obj
        arglist = [
    ...
    def test_server_list_with_all_projects(self, mock_list, mock_find):
        network_obj = mock.Mock()
        network_obj.name = 'private'
        mock_find.return_value = network_obj
        arglist = [
