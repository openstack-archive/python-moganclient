...
class TestServer(test_base.TestBaremetalComputeV1):
    fake_server = fakes.FakeServer.create_one_instance()
...
class TestServerCreate(TestServer):
    ...
    def _test_create_fake_server(self, mock_create, mock_find,
        ...
        fk_server = fakes.FakeServer.create_one_instance(called_data)
...
class TestServerUpdate(test_base.TestBaremetalComputeV1):
    def setUp(self):
        ...
        self.fake_server = fakes.FakeServer.create_one_instance()
