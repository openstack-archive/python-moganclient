...
class TestResource(base.TestBase):
    ...
    def test_init_with_attribute_info(self):
        ...
        self.assertTrue(hasattr(r, 'spam'))
...
class TestManager(base.TestBase):
...
class ListWithMetaTest(base.TestBase):
...
class DictWithMetaTest(base.TestBase):
...
class TupleWithMetaTest(base.TestBase):
...
class StrWithMetaTest(base.TestBase):
...
class BytesWithMetaTest(base.TestBase):
...
if six.PY2:
    class UnicodeWithMetaTest(base.TestBase):
