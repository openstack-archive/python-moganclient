...
class TestManager(test_base.TestBase):
    ...
    def test_manager_update(self):
        ...
        expect_url = (fakes.FAKE_RESOURCE_ITEM_URL % fakes.FAKE_RESOURCE_ID)
        self.fake_manager.api.patch.assert_called_once_with(expect_url,
                                                            data=fake_resource,
                                                            headers={})
    ...
    def test_manager_delete(self):
        ...
        expect_url = (fakes.FAKE_RESOURCE_ITEM_URL % fakes.FAKE_RESOURCE_ID)
        self.fake_manager.api.delete.assert_called_once_with(expect_url,
                                                             headers={})
    ...
    def test_manager_create(self):
        ...
        self.assertFalse(result.is_loaded())
        expect_url = fakes.FAKE_RESOURCE_COLLECTION_URL
        self.fake_manager.api.post.assert_called_once_with(expect_url,
                                                           data=fake_resource,
                                                           headers={})

    def test_manager_find(self):
        with mock.patch.object(self.fake_manager.api, 'get') as mock_get:
    ...
    def test_manager_find_no_result(self):
        with mock.patch.object(self.fake_manager.api, 'get') as mock_get:
    ...
    def test_manager_find_more_than_one_result(self):
        with mock.patch.object(self.fake_manager.api, 'get') as mock_get:
            fake_json_body_1 = dict(id=fakes.FAKE_RESOURCE_ID,
                                    name=fakes.FAKE_RESOURCE_NAME)
